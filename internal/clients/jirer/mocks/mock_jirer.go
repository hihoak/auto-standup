...
func (m *MockJirer) GetIssueLogTimeForTheLastWorkDay(cfg *utils.Config, issue jira.Issue) int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIssueLogTimeForTheLastWorkDay", cfg, issue)
	ret0, _ := ret[0].(int)
	return ret0
}
...
func (mr *MockJirerMockRecorder) GetIssueLogTimeForTheLastWorkDay(cfg, issue interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIssueLogTimeForTheLastWorkDay", reflect.TypeOf((*MockJirer)(nil).GetIssueLogTimeForTheLastWorkDay), cfg, issue)
}
